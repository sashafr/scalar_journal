...
class System extends MY_Controller {
	...
	/* When searching, have it redirect to get_index_books_desc_tags instead of get_index_books
	   JP
	 */
	public function index() {
		...
		if (isset($_REQUEST['sq']) && !empty($_REQUEST['sq'])) {
			$this->data['other_books'] = $this->books->get_index_books_desc_tags(false, $_REQUEST['sq']);
