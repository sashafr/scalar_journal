...
<? else: ?>
	<a href="javascript:;" class="inline_icon_link reply reply_link">Review this <?=$type?></a>
<? endif ?>
...
<? endif; ?>
	...
	<div class="maximize" id="comments" style="opacity: 1;">
		...
		<div class="maximize_content maximize_content_static_width">
			...
			<div class="saved" style="margin-bottom:14px;">Your review has been saved<?=(@$_GET['moderated'])?' and is awaiting moderation.':' and is viewable below.'?></div>
			<? endif ?>
...
?>
	...
	<div id="comment_contribute">
		...
		<div id="comment_form_wrapper" style="display:none;">
			...
			<tr><td class="field">Peer review title</td><td class="value"><input type="text" name="dcterms:title" value="" class="input_text"></td></tr>
