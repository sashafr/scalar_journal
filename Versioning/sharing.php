...
<?php
	...
	echo "</tr>\n";
	echo '<tr typeof="books">';
	// Since we're just allowing all books to be duplicatable, just comment out this part
	// JP
	...
	//echo 'Allow book to be duplicated by others? &nbsp;<select id="duplicatable"><option value="1">Yes</option></select>';
