                                        ...
                                        '<ul class="nav navbar-nav navbar-right" id="ScalarHeaderMenuRight">'+
                                            ...
                                            */
                                            ...
                                            ((base.is_author||base.is_commentator)?
                                                ...
                                                //<a class="headerIcon" href="' + base.get_param(scalarapi.model.urlPrefix + 'new.edit')+'" id="newIcon" title="New page button."><span class="visible-xs" id="newSpan">New page</span></a>
                                                '<li id="ScalarHeaderNew"></li>'
                                                :'')+
